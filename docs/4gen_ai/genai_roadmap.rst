...
Dieser Abschnitt führt durch die Konzepte der **generativen KI** und **Large Language Models (LLMs)** in einer klaren, praxisnahen Reihenfolge. Die folgenden Kapitel bauen aufeinander auf.
...
Die gleichen Konzepte stecken hinter Produkten wie **ChatGPT**, **Claude**, **Gemini** oder **RAG-Copilots** – hier werden die Bausteine, die dort genutzt werden.

Hinweis zu den Kapiteln
-----------------------

* Die **Hauptkapitel** (von der Einführung bis RAG und Grenzen) bilden den Kern des GenKI-Blocks. Die Kapitel können nacheinander durchgearbeitet werden.
